    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        input_vande_vande.setOnCheckedChangeListener { group, checkedId ->
            if(checkedId == R.id.benhly_vande){
                var URL_GET : String = "https://apptm.000webhostapp.com/khoa_luan/API/Branch_VanDe/api_show_vande_nhomvd.php?key_nhom_dich_vu=2"
                clearListVideo()
                ...
                var URL_GET : String = "https://apptm.000webhostapp.com/khoa_luan/API/Branch_VanDe/api_show_vande_nhomvd.php?key_nhom_dich_vu=1"
                clearListVideo()
                Getdata().execute(URL_GET)
                initAdapter()
                initRecyclerView()
