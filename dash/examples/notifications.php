...
<head>
  ...
  <script type="text/javascript">
        const url ="http://localhost/do_an/API/show_lisT_again.php";
    fetch(url).then(
      res=>{
        res.json().then(
          data=>{
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  ...
                  <li class="nav-link"><a href="../Process/process_logout.php" class="nav-item dropdown-item">Log out</a></li>
                </ul>
              </li>
                ...
                <div class="places-buttons">
                  <div class="row">
                    <div class="col-md-6 ml-auto mr-auto text-center">
                      <h4 class="card-title">
                        Danh Sách Cần Xác Nhận Lần 2</h4>
