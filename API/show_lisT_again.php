...
$query = "SELECT stt,sdt,name,gioitinh,tenvande,time_cre,time_yeucau FROM list_booking inner join vande on list_booking.id_vande = vande.id_vande where id_trangthai='3'";
