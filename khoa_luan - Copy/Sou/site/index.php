    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3"> <?php echo $role; ?> <sup></sup></div>
            </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                              Lịch Khám Hôm Nay  </div><a target="_blank" rel="nofollow" href="list_today.php"><small>Chi Tiết</small> &rarr;</a>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count_today;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-clipboard-list fa-2x text-gray-300"></i> <!-- fas fa-dollar-sign-->
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Đơn đã duyệt
                                            </div><a target="_blank" rel="nofollow" href="listt_accept.php"><small>Chi Tiết</small> &rarr;</a>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $count_done;?></div>
                                                </div>
                                                <div class="col">
