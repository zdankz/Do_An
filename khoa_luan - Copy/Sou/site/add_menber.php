        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Thêm nhân sự</h1>
                    <p class="mb-4">Nha Khoa <a target="_blank"
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                          ...
                          <div class="form-group">
                            <label for="cars">Quyền Truy Cập</label>
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Username</h6>
                                    <input name="kinhnghiem" value="" type="text" class="form-control" class="form-control"id="exampleInputPassword1" placeholder="" required="" >
                            <small id="emailHelp" class="form-text text-muted">Vui lòng nhập username cho tài khoản đăng ký</small>
                          </div>
                        
                          <div class="form-group" >
                            <!-- <label for="">Password</label> -->
                            <h6 class="m-0 font-weight-bold text-primary">Password</h6>
                            <input name="pass" value="" type="text" class="form-control" class="form-control"id="exampleInputPassword1" placeholder="1 năm" >
                          </div>
