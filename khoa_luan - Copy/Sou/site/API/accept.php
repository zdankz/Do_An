<?php 
	...
	$query = "SELECT don_dat_lich.id_don_dat_lich,khach_hang.ho_ten_khach_hang,nha_si.ho_ten_nha_si,dich_vu.ten_dich_vu,don_dat_lich.thoi_gian_tao_don,don_dat_lich.thoi_gian_dang_ky,don_dat_lich.thoi_gian_du_tru_ket_thuc,don_dat_lich.chi_phi_uoc_tinh from don_dat_lich JOIN nha_si on nha_si.Id_nha_si= don_dat_lich.id_nha_si JOIN dich_vu on dich_vu.id_dich_vu = don_dat_lich.id_dich_vu join khach_hang on khach_hang.id_khach_hang = don_dat_lich.id_khach_hang where don_dat_lich.id_trang_thai =2";
