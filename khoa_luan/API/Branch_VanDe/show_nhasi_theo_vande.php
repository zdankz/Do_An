<?php
	...
	$arraydata = array();
			...
			# code...
			array_push($arraydata, new Lists($row['id_nha_si'],$row['ho_ten_nha_si'],$row['gioi_tinh_nha_si'],$row['so_dien_thoai_nha_si'],$row['trinh_do_nha_si'],$row['gioi_thieu_nha_si']));
					}
		echo json_encode($arraydata,256);
class Lists
	{
		function __construct($id_nha_si,$ho_ten_nha_si,$gioi_tinh_nha_si,$so_dien_thoai_nha_si,$trinh_do_nha_si,$gioi_thieu_nha_si)
