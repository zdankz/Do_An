<?php
	...
	$arraydata = array();
			...
			# code...
			array_push($arraydata, new Lists($row['id_dich_vu'],$row['ten_dich_vu'],$row['mota_dich_vu'],$row['hinh_anh_dich_vu'],$row['chiphi_dich_vu']));
...
class Lists
	{
		function __construct($id_dich_vu,$ten_dich_vu,$mota_dich_vu,$hinh_anh_dich_vu,$chiphi_dich_vu)
