<?php
	...
	$arraydata = array();
			...
			# code...
			array_push($arraydata, new Lists($row['id_nha_si'],$row['ho_ten_nha_si'],$row['gioi_tinh_nha_si'],$row['so_dien_thoai_nha_si'],$row['trinh_do_nha_si'],$row['gioi_thieu_nha_si'],$row['hinh_anh_nha_si'],$row['lich_lam_viec_nha_si'],$row['id_nhom_dich_vu']));
	...
	class Lists
	{
		function __construct($id_nha_si,$ho_ten_nha_si,$gioi_tinh_nha_si,$so_dien_thoai_nha_si,$trinh_do_nha_si,$gioi_thieu_nha_si,$hinh_anh_nha_si,$lich_lam_viec_nha_si,$id_nhom_dich_vu)
